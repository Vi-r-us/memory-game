...
const Game = () => {
  ...
  return (
    <div className="2xl:w-content-2xl xs:w-content-xs lg:w-content-lg sm:w-content-sm md:w-content-md w-content relative mx-auto flex min-h-dvh flex-col py-6 sm:pt-9 sm:pb-[2.35rem] 2xl:pt-[4.2rem] 2xl:pb-[2.05rem]">
